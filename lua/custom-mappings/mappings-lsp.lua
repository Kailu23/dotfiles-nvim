...
map("n", "gri", "<CMD>lua vim.lsp.buf.implementation()<CR>", vim.tbl_extend("force", opts, { desc = "go to implementation"}))
...
map({ "n", "v"}, "grt", "<CMD>lua vim.lsp.buf.type_definition()<CR>", vim.tbl_extend("force", opts, { desc = "LSP Type definition"}))
map({ "n", "v"}, "grr", "<CMD>lua vim.lsp.buf.references()<CR>", vim.tbl_extend("force", opts, { desc = "LSP References"}))
